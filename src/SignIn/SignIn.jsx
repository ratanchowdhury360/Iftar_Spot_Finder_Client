...
const SignIn = () => {
  const { signIn, googleSignIn, loading, user } = useContext(AuthContext);
      ...
      const msg =
        err.code === 'auth/invalid-credential' || err.code === 'auth/wrong-password'
          ...
          : err.code === 'auth/user-not-found'
            ? 'এই ইমেইলে অ্যাকাউন্ট নেই।'
            : err.message || 'লগইন করা যাচ্ছে না।';
      setError(msg);
    } finally {
